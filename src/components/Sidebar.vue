<template>
    <nav class="col-md-3 col-lg-2 d-md-block bg-light">
        <ul class="nav flex-column">
            <li class="nav-item" v-for="(label, name) in modes" :key="name">
...
<script>
    export default {
        ...
        data: () => ({
            modes: {
                '/direct': 'Прямая Марковская модель',
                '/reverse': 'Обратная Марковская модель',
                '/research': 'Исследование Марковской модели',
            },
        }),
        computed: {
            currentRoute() {
